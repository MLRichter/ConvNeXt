...
class RelativeSelfAttention(nn.Module):
    ...
    def __init__(
        ...
        self.proj = nn.Linear(in_features=in_channels, out_features=in_channels if out_channels is None else out_channels, bias=True)
...
class MOATAttnetion(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        if self.use_window:
            ...
            if self.scale_factor is not None:
                input_partitioned = input_partitioned
            else:
                input_partitioned = self.proj(input_partitioned)
            output = input_partitioned + self.drop_path(self.attention(self.norm_1(input_partitioned)))
...
def test():
    ...
    print(f'MAOT_0:{get_n_params(moat_0(num_classes=1000))}')
    print(f'MAOT_1:{get_n_params(moat_1(num_classes=1000))}')
    print(f'MAOT_2:{get_n_params(moat_2(num_classes=1000))}')
    print(f'MAOT_3:{get_n_params(moat_3(num_classes=1000))}')
    print(f'MAOT_4:{get_n_params(moat_4(num_classes=1000))}')

    print("use_window: True")
    print(f'MAOT_0:{get_n_params(moat_0(use_window=True, num_classes=1000))}')
    print(f'MAOT_1:{get_n_params(moat_1(use_window=True, num_classes=1000))}')
    print(f'MAOT_2:{get_n_params(moat_2(use_window=True, num_classes=1000))}')
    print(f'MAOT_3:{get_n_params(moat_3(use_window=True, num_classes=1000))}')
    print(f'MAOT_4:{get_n_params(moat_4(use_window=True, num_classes=1000))}')
    print("*" * 100)
    print("-" * 100)
    print("tiny_MOAT:")
    print(f'tiny_MOAT_0:{get_n_params(tiny_moat_0(num_classes=1000))}')
    print(f'tiny_MOAT_1:{get_n_params(tiny_moat_1(num_classes=1000))}')
    print(f'tiny_MOAT_2:{get_n_params(tiny_moat_2(num_classes=1000))}')
    print(f'tiny_MOAT_3:{get_n_params(tiny_moat_3(num_classes=1000))}')
    print("-" * 100)
